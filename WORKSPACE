...
load("//toolchains:workspace.bzl", "tf_repositories")
...
load("//toolchains:version_check.bzl", "check_bazel_version_at_least")
...
load("//toolchains:workspace.bzl", "tf_bind")
tf_bind()
