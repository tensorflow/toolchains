...
load("@org_tensorflow//third_party/nccl:nccl_configure.bzl", "nccl_configure")
...
load("//toolchains/remote:configure.bzl", "remote_execution_configure")
load("//toolchains/clang6:repo.bzl", "clang6_configure")
load("//toolchains/cpus/arm:arm_compiler_configure.bzl", "arm_compiler_configure")
load("//toolchains/embedded/arm-linux:arm_linux_toolchain_configure.bzl", "arm_linux_toolchain_configure")
...
load("//toolchains/remote_config:configs.bzl", "initialize_rbe_configs")
